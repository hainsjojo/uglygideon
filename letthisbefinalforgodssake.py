...
# edit to match your sink alsa_output.pci-0000_02_02.0.analog-stereo
SINK_NAME = 'alsa_output.pci-0000_02_02.0.analog-stereo'
METER_RATE = 344
...
def main():
	...
	if sample == 1:
		img = cv2.imread('bighead/1.jpg')
		cv2.imshow('gideon', img)
		cv2.waitKey(1)
		for i in range (1,10):
